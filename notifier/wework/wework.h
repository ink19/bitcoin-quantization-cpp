#ifndef _NOTIFIER_WEWORK_WEWORK_H
#define _NOTIFIER_WEWORK_WEWORK_H
...
class Wework {
public:
  Wework(const KeyWords &, asio::io_context &context, const std::string &token, const std::string &key_words);
...
private:
  ...
  const std::string host_name = "qyapi.weixin.qq.com";
